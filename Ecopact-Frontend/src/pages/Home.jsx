    ...
    <div>
      ...
      <section className='flex px-10 mt-2 py-8 items-center justify-center'>
        <div className='w-1/2 max-lg:text-center max-lg:min-w-full'>
          <h1 className='text-5xl font-bold pb-5 text-blue-950 max-sm:text-xl max-md:text-4xl'>AI-powered platform for water resource monitoring in Lagoon of Bizerte</h1>
